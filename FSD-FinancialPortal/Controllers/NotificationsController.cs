...
namespace FSD_FinancialPortal.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Created,Subject,Body,SenderId,RecipientId,Acknowledged")] Notification notification)
        {
            ...
            ViewBag.SenderId = new SelectList(db.Users, "Id", "FirstName", notification.SenderId);
            return View(notification);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Created,Subject,Body,SenderId,RecipientId,Acknowledged")] Notification notification)
        {
            if (ModelState.IsValid)
            {
