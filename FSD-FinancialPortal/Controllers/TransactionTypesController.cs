...
namespace FSD_FinancialPortal.Controllers
{
    public class TransactionTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Description")] TransactionType transactionType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Description")] TransactionType transactionType)
        {
            if (ModelState.IsValid)
            {
